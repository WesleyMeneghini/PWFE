...
const $sigla = document.getElementById("txt_sigla");
const $pesquisar = document.getElementById("btn_pesquisar");
const $resultado = document.getElementById("resultado");
// const $pesquisar2 = document.getElementById("btn_pesquisar2");
const $mostrarCidades = document.getElementById("mostrar_cidades");

// const click = false;


const mostraCidades = (json) => {
   ...
   for(let i = 0; i<tamanho; i++){
      ...
      if(json[i].sigla == $sigla.value.toUpperCase()){
         referencia = false;
         tamanhoCidades = json[i].cidades.length;

         for(let j = 0; j<tamanhoCidades; j++){
            if(j% 2 == 0){
               valores +="<div class='numero bkg-black'><h2>"+j+"</h2></div> <div class='cidades bkg-black'><h2>" + json[i].cidades[j].nome + "</h2></div>";
            }else{
               valores +="<div class='numero bkg-white'><h2>"+j+"</h2></div> <div class='cidades bkg-white'><h2>" + json[i].cidades[j].nome + "</h2></div>";
            }
...
const clickEvent = () => $mostrarCidades.innerHTML = mostraCidades(brasil);



$pesquisar.addEventListener("click", () => clickEvent());
